...
module.exports = function(app){
  ...
  const {getRegister,getEvent3,getEvent2,getEvent1,getHomeUser,getHomePage,getLogin,getVouchers,getCreateFromScratch,getCreateFromVoucher,getJoin,getUserAcc,registerUser,getUserProfile} = require('../controllers/createEventController.js');
